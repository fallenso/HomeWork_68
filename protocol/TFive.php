 ...
 * 539 頁面
 */
class TFive  extends TIProtocol {
	...
	{					
		...
		$this->m_param['page'] = "TFive";
		$this->m_param['MenuPage'] = $this->m_MenuFunction;
		$this->m_param['SubPagePath'] = TViewBase::GetPagePath('TFive/'.$this->m_MenuFunction);
		
		TViewBase::Main('TFive/TFive', $this->m_param);
	}
