 ...
 * 六合彩 頁面
 */
class TLottery  extends TIProtocol {
	...
	private function CarPage()
	{
		...
		$_carlimit = $_TGameBaseSet->ReadAboutCar();
		$_TGameBaseSet = null;
		$this->m_param['car_limit_down'] = $_carlimit['car_limit_down'];
		$this->m_param['car_limit_top'] = $_carlimit['car_limit_top'];
		$this->m_param['car_price_down'] = $_carlimit['car_price_down'];
		$this->m_param['car_price_top'] = $_carlimit['car_price_top'];
	...
	{					
		...
		$this->m_param['page'] = "TLottery";
		$this->m_param['MenuPage'] = $this->m_MenuFunction;
		$this->m_param['SubPagePath'] = TViewBase::GetPagePath('TLottery/'.$this->m_MenuFunction);
		
		TViewBase::Main('TLottery/TLottery', $this->m_param);
	}
